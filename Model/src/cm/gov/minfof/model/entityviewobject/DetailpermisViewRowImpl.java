...
public class DetailpermisViewRowImpl extends ViewRowImpl {
    ...
    protected enum AttributesEnum {
        ...
        Iddepartements,
        nomdudepartement,
        Idpartieproduitpfnlconsultation,
        DetailpermisView,
        DetailpermisView1,
        DetailpermisView2,
        PermisView,
    ...
    public static final int IDPARTIEPRODUITPFNLCONSULTATION = AttributesEnum.Idpartieproduitpfnlconsultation.index();
    ...
    public static final int APPMODULE_DEPARTEMENTVIEW3_1 = AttributesEnum.AppModule_DepartementView3_1.index();
    ...
    /**
     * Sets <code>value</code> as attribute value for nomdudepartement using the alias name nomdudepartement.
    ...
    /**
     * Gets the attribute value for the calculated attribute Idpartieproduitpfnlconsultation.
     * @return the Idpartieproduitpfnlconsultation
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute Idpartieproduitpfnlconsultation.
     * @param value value to set the  Idpartieproduitpfnlconsultation
     */
    public void setIdpartieproduitpfnlconsultation(BigDecimal value) {
        setAttributeInternal(IDPARTIEPRODUITPFNLCONSULTATION, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> AppModule_DepartementView3_1.
     */
    public RowSet getAppModule_DepartementView3_1() {
        return (RowSet) getAttributeInternal(APPMODULE_DEPARTEMENTVIEW3_1);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> DepartementEtRegionView1.
     */
    ...
    /**
     * Gets the view accessor <code>RowSet</code> AppModule_getLibelleFixe1_1.
     */
