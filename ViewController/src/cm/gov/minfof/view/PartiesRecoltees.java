...
public class PartiesRecoltees {
    ...
    public String enregPartiesRecoltees() {
        ...
        Object idEnCours = getExpressionValue("#{bindings.Idpartiesrecoltees.inputValue}");
        ...
        if (idEnCours == null || v.toString().equals("-1")) {
            Object dernierId = appScope.get("idpartiesrecolteesbean");
            if (dernierId == null) {
                //Je vais mettre à jour la liste qui compte les id
                DCIteratorBinding iterIB = (DCIteratorBinding) getBindings().get("getLastIdPartiesRecoltees1Iterator");
                ...
                if (vo.hasNext()) {
                    ...
                    appScope.put("idpartiesrecolteesbean", lastId);
                }
            } else {
                BigDecimal un = new BigDecimal(1);
            ...
            setExpressionValue("#{bindings.Idpartiesrecoltees.inputValue}", lastId);
        }
