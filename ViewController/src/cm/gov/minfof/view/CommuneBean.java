...
public class CommuneBean {
    ...
    public String enregistreCommune() {
        ...
        Object idEnCours = getExpressionValue("#{bindings.Idcommunes.inputValue}");
        ...
        if (idEnCours == null || v.toString().equals("-1")) {
            Object dernierId = appScope.get("idcommunebean");
            if (dernierId == null) {
                //Je vais mettre à jour la liste qui compte les id
                DCIteratorBinding iterIB = (DCIteratorBinding) getBindings().get("getLastIdCommunes1Iterator");
                ...
                if (vo.hasNext()) {
                    ...
                    appScope.put("idcommunebean", lastId);
                }
            } else {
                BigDecimal un = new BigDecimal(1);
            ...
            setExpressionValue("#{bindings.Idcommunes.inputValue}", lastId);
        }
