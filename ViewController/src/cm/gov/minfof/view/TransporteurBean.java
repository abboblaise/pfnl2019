...
public class TransporteurBean {
    public TransporteurBean() {
    }
    ...
    public String creerTransporteur() {
    ...
    public String enregistrerTransporteur() {
        BindingContainer bindings = getBindings();
    ...
    public String supprimerTransporteur() {
        BindingContainer bindings = getBindings();
