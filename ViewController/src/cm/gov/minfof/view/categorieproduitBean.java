...
public class categorieproduitBean {
    ...
    public String enregistrerCateg() {
        ...
        Object idEnCours = getExpressionValue("#{bindings.Idcategorieproduit.inputValue}");
        ...
        if (idEnCours == null || v.toString().equals("-1")) {
            Object dernierId = appScope.get("idcategproduitbean");
            if (dernierId == null) {
                //Je vais mettre à jour la liste qui compte les id
                DCIteratorBinding iterIB = (DCIteratorBinding) getBindings().get("getLastIdCategorieProduit1Iterator");
                ...
                if (vo.hasNext()) {
                    ...
                    appScope.put("idcategproduitbean", lastId);
                }
            } else {
                BigDecimal un = new BigDecimal(1);
            ...
            setExpressionValue("#{bindings.Idcategorieproduit.inputValue}", lastId);
        }
